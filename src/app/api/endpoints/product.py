...
async def update_product_id(
    ...
    updated_product = await repo.update_product(
        id, product_obj.title, product_obj.description, product_obj.price
    )
...
async def create_product_flavours(
    ...
    """
    new_product_flavour = await product_flavour_repo.create_product_flavours(
        product_flavour
    )
...
async def get_products_flavours(
    product_flavour_repo: ProductFlavourRepository = Depends(ProductFlavourRepository),
):
    """
...
async def update_products_flavours_id(
    ...
    - title
    """
    updated_product_flavour = await repo.update_product_flavour(id, product_flavour.title)
